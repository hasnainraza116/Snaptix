      ...
      <div className="relative mx-auto max-w-[1440px] grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
        {stats.map((stat, i) => (
          <motion.div
            ...
            className="rounded-3xl border border-paper/10 bg-void/40 px-4 py-8 backdrop-blur-sm"
          >
            <div className="font-display text-4xl md:text-5xl bg-gradient-to-r from-signal via-violet to-coral bg-clip-text text-transparent">
